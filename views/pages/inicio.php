        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="categories-container">
                    ...
                    <!-- Category Box -->
                    <a href="jobs-grid-layout-full-page.htm" class="category-box">
                    ...
                    <!-- Category Box -->
                    <a href="jobs-list-layout-full-page-map.htm" class="category-box">
                        <div class="category-box-icon">
                    ...
                    <!-- Category Box -->
                    <a href="jobs-list-layout-1.htm" class="category-box">
                        <div class="category-box-icon">
                    ...
                    <!-- Category Box -->
                    <a href="jobs-list-layout-2.htm" class="category-box">
                        <div class="category-box-icon">
        ...
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="section-headline margin-top-0 margin-bottom-35">
                    <h3>Featured Jobs</h3>
                    <a href="jobs-list-layout-full-page-map.htm" class="headline-link">Browse All Jobs</a>
                </div>
                ...
                <div class="listings-container compact-list-layout margin-top-35">
                    ...
                    <!-- Job Listing -->
                    <a href="single-job-page.htm" class="job-listing with-apply-button">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-1.htm" class="photo-box" data-background-image="images/featured-city-01.jpg">
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-full-page-map.htm" class="photo-box" data-background-image="images/featured-city-02.jpg">
                    <div class="photo-box-content">
                        <h3>New York</h3>
                        <span>645 Jobs</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-grid-layout-full-page.htm" class="photo-box" data-background-image="images/featured-city-03.jpg">
                    <div class="photo-box-content">
                        <h3>Los Angeles</h3>
                        <span>832 Jobs</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-2.htm" class="photo-box" data-background-image="images/featured-city-04.jpg">
                    <div class="photo-box-content">
                        <h3>Miami</h3>
                        <span>513 Jobs</span>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                <div class="section-headline margin-top-0 margin-bottom-25">
                    ...
                    <a href="freelancers-grid-layout.htm" class="headline-link">Browse All Freelancers</a>
                </div>
            </div>
                ...
                <div class="default-slick-carousel freelancers-container freelancers-grid-layout">
                    ...
                    <div class="freelancer">
                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <div class="freelancer-avatar">
                                    ...
                                    <a href="single-freelancer-profile.htm"><img src="images\user-avatar-big-01.jfif" alt=""></a>
                                </div>

                                <!-- Name -->
                                <div class="freelancer-name">
                                    <h4><a href="single-freelancer-profile.htm">Tom Smith <img class="flag" src="images\flags\gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
                        ...
                        <div class="freelancer-details">
                            ...
                            <a href="single-freelancer-profile.htm" class="button button-sliding-icon ripple-effect">View Profile <i class="icon-material-outline-arrow-right-alt"></i></a>
                        </div>
                    </div>
                    <!-- Freelancer / End -->
                    ...
                    <div class="freelancer">
                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <div class="freelancer-avatar">
                                    <div class="verified-badge"></div>
                                    <a href="single-freelancer-profile.htm"><img src="images\user-avatar-big-02.jfif" alt=""></a>
                                </div>
                    ...
                    <div class="freelancer">
                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <!-- Avatar -->
                                <div class="freelancer-avatar">
                                    <a href="single-freelancer-profile.htm"><img src="images\user-avatar-placeholder.png" alt=""></a>
                                </div>
                    ...
                    <div class="freelancer">
                        ...
                        <div class="freelancer-overview">
                            <div class="freelancer-overview-inner">
                                ...
                                <div class="freelancer-avatar">
                                    <div class="verified-badge"></div>
                                    <a href="single-freelancer-profile.htm"><img src="images\user-avatar-big-03.jfif" alt=""></a>
                                </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="pricing-plans-container">
                    ...
                    <div class="pricing-plan">
                        ...
                        <a href="pages-checkout-page.htm" class="button full-width margin-top-20">Buy Now</a>
                    </div>
